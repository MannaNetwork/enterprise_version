...
echo '<h1>dirname( __FILE__, 3 )', dirname( __FILE__, 3 );
...
echo $sql;
$result = mysqli_query($mysqli, $sql) or die("Couldn't execute 'Edit 26 Account' query");
...
$result = mysqli_query($mysqli, $sql) or die("Couldn't execute 'Edit 36 Account' query");
 while($row = mysqli_fetch_assoc($result)){
$lft = $row['lft'];
}
//| 3379 
...
$result = mysqli_query($mysqli, $sql) or die("Couldn't execute 'Edit 46 Account' query");
 while($row = mysqli_fetch_assoc($result)){
$lft2 = $row['lft'];
}
//16623
...
$result = mysqli_query($mysqli, $sql) or die("Couldn't execute 'Edit 56 Account' query");
 while($row = mysqli_fetch_assoc($result)){
...
$result = mysqli_query($mysqli, $sql) or die("Couldn't execute 'Edit 66 Account' query");
 while($row = mysqli_fetch_assoc($result)){
$t_timestamp = $row['t_timestamp'];
}
//2018-09-21 01:36:22
...
$result = mysqli_query($mysqli, $sql) or die("Couldn't execute 'Edit 76 Account' query");
 while($row = mysqli_fetch_assoc($result)){
$id = $row['id'];
}
//4538
...
$url="http://exchange.manna-network.cash/adminmn/broadcast/collect_links_data.php";
