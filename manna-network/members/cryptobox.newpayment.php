...
// This is what gourl inserts with	$sql = "INSERT INTO crypto_payments (boxID, boxType, orderID, userID, countryID, coinLabel, amount, amountUSD, unrecognised, addr, txID, txDate, txConfirmed, txCheckDate, recordCreated)
...
These inputs needed for price_slot_day_ledger
id
user_id
link_id
balance
...
We need to retrieve the last balance for this user and add/tally the deposit amount to the previous balance

WE maybe need to update BungeeBank_balance - This is just an entry table, a receipt book, I think. Everything posted in the vrytoapi table will be duplicated here
id
BB_user_ID
BB_bank_ID
t_timestamp
