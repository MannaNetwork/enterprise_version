...
function showSubLoc1(str, main_cat_nonce,currentLevel,cat_id,type,agent_url,agent_foldername) 
{
var myarr = str.split(":");
window.alert("in registration.js agent_url,agent_foldername = "+agent_url+','+agent_foldername);
