...
if(type=="regions"){
output += '<input type="hidden" id="location_name" name="location_name" class ="location_name" value=""><input type="hidden" id="location_id" name="location_id" class ="location_id" value="'+myarr[1]+'"></select></form>';
...
output += '<input type="hidden" id="selected_cat_name" name="selected_cat_name" class ="selected_cat_name" value=""><input type="hidden" id="selected_cat_id" name="selected_cat_id" class ="selected_cat_id" value="'+myarr[1]+'"></select></form>';
...
window.alert('selected_cat_id asmyarr[1]= '+myarr[1]);
document.getElementById("selected_cat_id").value = myarr[1]; 

}
    ///////
    
 window.alert('looking for "Sorry, No More Regional Filters Found" from data ='+data);
elseif(combo_list == "NO MORE SUB CATEGORIES" || combo_list == "Sorry, No More Regional Filters Found.")
{
...
window.alert('selected_cat_id asmyarr[1]= '+myarr[1]);
	 document.getElementById("selected_cat_id").innerHTML = myarr[1]; 
	 document.getElementById("selected_cat_menu_name").innerHTML = myarr[2];
	}
}   
