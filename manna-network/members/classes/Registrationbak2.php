...
echo '<br>in ORG MN/members/classes/Registration. Trying to fix the double display of header and footer. This echo is just before script creates messages object (line 390). It use a var $this->lang and then a constant is used to add it as an array item';
echo '<br>$this->lang (is an arry so won\'t probably echo), $this->lang';
print_r($this->lang); 
