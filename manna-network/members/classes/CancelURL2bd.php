...
$send_array = array($num_links_this_user, $id, $user_id2, $recruiter_lnk_num, $website_title, $website_description, $website_url, $category_id, $location_id, $website_street, $user_registration_datetime, $installer_id);
