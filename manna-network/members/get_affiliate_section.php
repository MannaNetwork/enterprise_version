...
$affil_blockmaf .= "<br><a target='_blank' href='../members/modal/buy_placement.php?link_id=$db_idaf[$key]' title='Better Placement Control Panel' ><div style=\"width:100px; background-image: url('images960/1x1tran.gif'); background-repeat: repeat-x; background-color: orange; color:white; font-size:100%;-moz-border-radius: 15px;
...
else
{
   ...
   $affil_blockmaf .= "<p style='text-align:left; font-size:10px;'>Get Placed Ahead <br>Of <u>All</u> Other <br>Free Links <br>For Less Than <br>A Penny A Month!</p>";
...
//$affil_blockmaf .= "' title='Better Placement Control Panel' rel='gb_page_center[840, 480]'><div style=\"width:100px; background-image: url('images960/1x1tran.gif'); background-repeat: repeat-x; background-color: orange; color:white; font-size:100%;-moz-border-radius: 15px;  border-radius: 15px;text-align: center;\">Purchase Better Placement</div></a>";
...
<a   href="reports/user_cp_commissions_reports.php?link_selected=' .$db_idaf[$key].'&type=stats" class="cssbutton sample b"><div style="width:150px; background-image: url(\'images960/1x1tran.gif\'); background-repeat: repeat-x; background-color: navy; color:#ffffff; font-size:100%;-moz-border-radius: 15px;
										   border-radius: 15px;text-align: center;">Affiliate<br>&nbsp;Site&nbsp;Stats<br> &nbsp;Commission Mgmt&nbsp;</div></a>';
										      }
...
<a   href="reports/user_cp_commissions_reports.php?link_selected=' .$db_idaf[$key].'&type=stats" class="cssbutton sample b"><div style="width:150px; background-image: url(\'images960/1x1tran.gif\'); background-repeat: repeat-x; background-color: navy; color:#ffffff; font-size:100%;-moz-border-radius: 15px;
										...
										//$affil_blockmaf .= '<br><a href="change_link_index.php/'.$db_categoryaf[$key]."/".$db_idaf[$key].'" class="cssbutton sample a"><div style="width:150px; background-image: url(\'images960/1x1tran.gif\'); background-repeat: repeat-x; background-color: navy; color:#ffffff; font-size:100%;-moz-border-radius: 15px;	border-radius: 15px;text-align: center;">&nbsp;EDIT&nbsp;INFO</div></a>&nbsp;';
