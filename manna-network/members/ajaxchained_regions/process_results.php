...
echo 'This page is in development. It now reports the regions selected via AJAX. We can now generate a new link query to populate the directory with links from that region ONLY. ';
