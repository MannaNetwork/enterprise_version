...
<body onload="ajax_regions_form.reset()";>
<?
include($_SERVER['DOCUMENT_ROOT']."/960top_regform.php");
?>
<form id= "ajax_regions_form" method="post" action="http://bungeebones.com/members/ajaxchained_regions/process_results.php" name="ajax_dd_form">
...
<select name="continent" onChange="getCountry(this.value), getContinentURL(this.value), deleteStateURL(this.value), deleteCountryURL(this.value), deleteCityURL(this.value)">
