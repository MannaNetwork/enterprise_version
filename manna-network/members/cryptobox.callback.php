...
/*
$sql = "INSERT INTO bb_test (userid,  amount,  txid)
						VALUES ('".$res["user"]."', ".$res["amount"].", '".$res["tx"]."')";
...
{
//if($payment_details['status'] == 'payment_received' AND $payment_details['user'] != ""){

$user_id = $payment_details['user'];
$deposit_amount = $payment_details['amount'];
$txid = $payment_details['tx'];
$from_address = $payment_details['addr'];
$cold_wallet_address = "3AqHLAadV";
$box_status = "cryptobox_newrecord";
//this db table doesn't seem to be used anymore - marked for deprecation 1/12/2016
$sql = "INSERT INTO bb_test (userid,  amount,  txid)
						VALUES ('$user_id', ".$deposit_amount.", '".$txid."')";
