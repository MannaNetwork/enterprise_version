...
$blockt_message = "Your current bid and rank (right column). Your current priceslot places you ahead of all other advertisers except those paying with actual BitcoinSV (instead of Demo Coin). New, higher bids can be submitted at any time which will move your position down one spot for each. You can change your price slot at any time. Study the strategy page for ideas on when and why you might want to consider changing your bid.</span>"; 
