...
define("WORDING_REGIONAL_REG_LABEL", "<h4>Advertise To LOCATIONS</h4>");
...
define("WORDING_AJAX_REGIONAL_REG_EDIT", "Add/Change Regional Info (optional) - Continent");
...
define("EDIT_FORM_WELCOME_TITLE", "Edit Your Link To Our Classified Section!");
define("EDIT_FORM_WELCOME_BODY", "<p align='left'>Caution: editing your link info will:</p>
<ul><li>Cause it to be resubmitted for review (your current ad will continue to be displayed as it stands)</li>
<li>Changing category will cause it to get a new seniority date (changes to title, description, regional info will not)</li>
</ul>");
...
define("WORDING_ADD_A_LINK", "Submit Your Changes");
...
define("WORDING_REGISTRATION_TITLE", "<h3>Title - changes will not be displayed until reviewed but will not affect your seniority date/ranking.</h3>");
define("WORDING_REGISTRATION_URL", "<h3>Your Website URL - NOT EDITABLE</h3>");
define("WORDING_REGISTRATION_DESCRIPTION", "<h3>Description - Enter a 50 to 255 character description of your website or business(changes will not be displayed until reviewed but will not affect your seniority date/ranking)</h3>");
define("WORDING_REGISTRATION_CATEGORY", "<h3><b>Category (required) -</b> Select the BEST category for your website or business listing from among either main categories or subcategories (Hint: the higher the category, the more the competition). Changes to just the category will not be reviewed but will cause a new seniority date.</h3>");
