...
$modified_confirm_message = "<h3 style ='font-weight: bold; background-color: #bbff0077;'>Your new bid will be entered in the queue ready to be activated. Your ad's current position will remain unchanged pending that process. Your final display position will be determined when it is compared to other bids in this category at that daily processing. Your will be able to see your new bid position when you refresh the bidding page but you can still change it. Your bid will receive the seniority date based upon the time this new bid was submitted (not the time when the process is run). The bid/subscription renews daily and automatically until you cancel or your account runs out of funds. </h3>";
define("WORDING_REGIONAL_MENU", "Rank By Location Filters");
define("SUCCESSFUL_BID_SUBMISSION1", "<h1>Thank you!</h1> 
<h4  style='text-align:left;'>The transaction has been recorded here at your agent site and also has been sent along to Manna Network to be compared with all other bids. They will be ordered highest to lowest and by seniority (i.e. according to when bought). The purchase will initiate a subscription with regular automatic daily deductions from your appropriate \"prepaid\" account (i.e. either Bitcoin or Demo coin as you have selected). The daily fee will be deducted from this point forward until any of the following: 1) cancelled by you 2) you change the price slot (doing so resets your seniority in the new price slot) or 3) there is insufficient funds in your account.</h4><h4><a  style=' color:navy; text-decoration:underline;' href='index.php'>Return to your Member Dashboard</a>");
...
define("FAILED_BID_SUBMISSION", "<h1>SORRY!</h1> 
<h4  style='text-align:left;'>We were not able to process your bid. Please try again and, if the problem persists then, please contact tech support for assistance</h4><h4><a style=' color:navy; text-decoration:underline;' href='index.php'>Return to your Member Dashboard</a>");
...
$cancel_success_message  = "<h1>SUCCESS!</h1><p>Your paid ad had been canceled and your ad will now return to its original free ad status.  Your new position will take affect at the next ad reordering (i.e. tomorrow)</p>";
