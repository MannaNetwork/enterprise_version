...
const still_more_locs_city = '<h4 style="font-size:small;">Now your listing will appear when users filter for that city.</h4>';
const still_more_cats = '<h4 style="font-size:small;">Still More Subcategories To Choose From.</h4>';

const no_more_subs = '<h4 style="font-size:small;">No More Subs.</h4>';
