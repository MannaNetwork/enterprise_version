...
if(empty($_POST['get_all']))
	{
		$errorMessage .= "<li>You forgot to enter a get_all!</li>";
	} 
...
$new_assign = $assign_mng->generate_wtm_list($selection_filter);
echo 'new assign ';
print_r($new_assign);
		exit;
	}
...
<p style="text-align: left;">Use this form to assign both the income derived from the current subscribers of a site, the subscribers of its DOWNLINE and also any FUTURE sales or recruits of itself or its downline.
	...
	?>
	<form action="generate_wtm_list.php" method="post">
...
<input type="radio" name="get_all" value="true">Get All<br>
