...
<p style="text-align: left;">Think out loud - How does a buyer need to enter the system? As a bb registrant right? The buyer would be buying the same level as the seller. Gets that level from where? Widget ID? Link ID or User ID?
<p style="text-align: left;">Link ID7033 	User 8362 	0 	0 	10023 	0 	http://roberts_test.bitcoin_derivative
	<?php
		if(!empty($errorMessage)) 
		{
