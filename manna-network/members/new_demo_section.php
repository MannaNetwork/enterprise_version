...
$demo_link_block = "";
$demo_link_block .= PRE_TTLSEC.$db_nametn[$key].PRE_LNKID.$db_idtn[$key].PRE_CATNAME.$cat_nametn.PRE_CATPOP.$catPop1[14].PRE_LNKPOS.$getThisLinksFreeRank.PRE_WDGT_SWTCH.$db_idtn[$key].PRE_BUYAD.$db_idtn[$key].PRE_LNKDESC.$db_descriptiontn[$key].PRE_EDITBTN.$db_categorytn[$key]."/".$db_idtn[$key].PRE_DELETEBTN."&cat_id=".$db_categorytn[$key].BLOCK_END; 

echo '$demo_link_block = ', $demo_link_block;
