...
<body>
<?php include($_SERVER['DOCUMENT_ROOT']."/members/template_topy.php");
...
<table>
<tr> <td>EUR ticker in TEXT format</td><td><?php echo cachegetBitcoinPrice( "text", "line", "EUR" ); ?></td><td><a href="http://p.b.gw.gd/tickers/ticker_eur_btc.php?type=text">TEXT BTC/EUR ticker</a> </td></tr>
...
<?php include($_SERVER['DOCUMENT_ROOT']."/members/templatebottomnsb.php"); ?>
</body>
</html>
