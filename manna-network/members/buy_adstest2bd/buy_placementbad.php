...
$display_blockmp .= '<p><a href="../config_prefixes.php?link_id='.$selected_link_id.'">Configure Your Display (Move the Decimal Point)</a>&nbsp;&nbsp;&nbsp;<a href="../config_price_slots.php?link_id='.$selected_link_id.'">Configure Your Display (Price Slot Range)</a></p>';
...
{
//simple form to select whether to use testnet or bitcoin
// might be able to ignore this choice if they only have a balance of one or the other
// so on members page - pseudo code = if($balance="" AND balancetn!=""){$A1 = testnet }elseif ($balance!="" AND $balancetn=""){$A1 = bitcoin }else {$A1 = "both"}
}
