...
$display_block .= "<input type='hidden' name='previous_coin_type' value='testcoin'>";
if($satoshi!=1){
...
if($satoshi!=1){
 $display_block .= "</hr><h4 style='color:red;'>Your Previous Purchased Price Slot Was (". (float)$moved_decimal." " .$prefix."TTC) and will be cancelled.";
}
...
if($t <= $high AND $t >= $low){ 
			 ...
			 $display_block1 .= "<td STYLE='font-size: 100%;'>".$num_links_in_slot." bitcoin link";
