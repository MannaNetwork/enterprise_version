...
echo '<h2>In A1 - Purchase Any Price Slot And Move Your Link Position Ahead Of All Free Advertising!</h2>';
...
<p>To start using your credit just scroll to the right along the row of potential price slots below until you find the radio button of the amount you want to spend. Then click the "Process Now" button to submit the form.
 ';
//getUserByLinkId
