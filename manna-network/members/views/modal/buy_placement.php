...
echo "
<h1>You have a balance in both your Bitcoin account (".$balance_bitcoin.") and in your DemoCoin account (".$balance_testcoin."). Which do you want to use for this purchase? </h1>
...
<h3>To add more Bitcoin to your account go to <a href='/members/Examples/example_basic.php?user_id=".$user_id."'>the Bitcoin Deposit page</a> to get an address and follow the instructions to send Bitcoin.</h3>
...
<h1>You have a balance available in your Bitcoin account (".$balance_bitcoin."). Proceed if you wish to purchase better placement with Bitcoin. If you wish to add Testcoin (free) and use it instead go to <a href='/feedback.php'>the Contact page</a> and request some from the administrator.
<h3>To add more Bitcoin to your account go to <a href='/members/Examples/example_basic.php?user_id=".$user_id."'>the Bitcoin Deposit page</a> to get an address and follow the instructions to send Bitcoin.</h3>";
...
<h1>You have a balance available in your Testcoin account (".$balance_testcoin."). Proceed if you wish to purchase better placement with your Democoin (understand that you can be outbid by even the tiniest amount of Bitcoin). </h1>
<h3>If you wish to add Bitcoin and use it instead go to <a href='/members/Examples/example_basic.php?user_id=".$user_id."'> the Bitcoin Deposit Form</a>  to get an address and the instructions.
<h3>To add more Democoin to your account go to <a href='/feedback.php'>the Contact page</a> and request some from the administrator.</h3>
...
echo '<h3>We have not detected a balance in your account. Would you like to fund it now with Free demo coin? They act just like Bitcoin but have no cash value and we use them to provide our users a demo of our system and to let them see how how bidding system works).</h3>';
echo '<h3>To fund your account with Democoins go to <a href="/feedback.php">the Contact page</a> and request some from the administrator.</h3>';
echo '<h3>To add Bitcoin to your account go to <a href="/members/Examples/example_basic.php?user_id='.$user_id.'">the Bitcoin Deposit page</a> to get an address and follow the instructions to make a Bitcoin deposit (note, the deposit amount is set very very low while we are in startup mode).</h3>';
}
