...
//echo '<br>line 582 get frozen = ', $get_frozen_offered;
//echo '<br>line 582 get frozen = ', $get_frozen_accepted;

//echo '<br>';
//foreach ($get_frozen[0] as $key=>$value){
//echo '<br> key = ', $key;
...
$msg .=   "<div><h1>Your available balance of Advertising Credits that you could offer for sale is $balance</h1></div>";
}
