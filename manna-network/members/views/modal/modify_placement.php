...
{
	//coming in from the form, it is either a testnet or a bitcoin or free, so get the include accordingly. It also may be an exchange
...
echo "<h2>You have a balance in both your Bitcoin account (".$balance_bitcoin.") and in your TestCoin account (".$balance_testcoin."). 
</h2><p>To Switch from your current $coin_type price slot to the opposite coin (\"$opposite_coin_type\") choose the $opposite_coin_type radio button (it will automatically cancel the existing price slot listing)</p>
<p>To Cancel or Modify (upgrade or downgrade position) and <b>remain</b> with your existing coin type select the $coin_type radio button</p>
<input type='radio' name='fut_buyr_type' value='bitcoin'> Bitcoin&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <input type='radio' name='fut_buyr_type' value='testcoin'>Testcoin<br>
<h4>To add more Testcoin to your account go to <a href='../testcoin_deposit'>the Testcoin Deposit page</a> to get an address and follow the instructioons to go the testnet net faucet.</h4>
<h4>To add more Bitcoin to your account go to <a href='../bitcoin_deposit'>the Bitcoin Deposit page</a> to get an address and follow the instructioons to go the testnet net faucet.</h4>";
}
