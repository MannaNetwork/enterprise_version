<?php
function cachegetBitcoinPrice( $type, $geo="line", $currency="USD" ) 
{
//had to comment out all cache related conditions in order to get this to work
 //echo $geo;
...
if ( $type == "php_array" )
	{
	 $returndata= array($last, $high,$low,$avg,$vol,$bid,$ask);
