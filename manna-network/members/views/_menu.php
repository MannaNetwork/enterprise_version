 <ul class="navmenu">
	...
	<li><a href="exchange.php">Ad Credit Exchange</a></li>
...
<div>&nbsp;</div><div id="index_content" class="index_content" name="index_content"><hr>
            ...
            <section class="wrapper">
             <!--  <h1><a href="./index.html" class="brand">Brand</a></h1>
               ...
               <nav class="navbar">
                  ...
                  <ul class="menu">
                     <li class="menu-item"><a href="/advertise/">Top Level</a></li>
                     <li class="menu-item"><a href="/advertise?get_about_info=true">About</a></li>
