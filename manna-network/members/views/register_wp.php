  <?php
/* This is a direct copy of the original register page as used by the iframe version. Since switching to curl (instead of iframe) moves the method from GET to POST, the main difference in this code is that it uses the POST method */
