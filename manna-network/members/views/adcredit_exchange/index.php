...
<p class='smallerFont'>The links and processes listed below enable Manna Network users that have Advertising Credits in their account to offer them for sale and for other members of Manna-Network.com to buy them. It is an automated system provided free of charge by Manna-Network.com to Manna Network' users. Manna Network is NOT a crypto currency broker, NOR an exchange, NOR an escrow service, NOR an arbitration service. The process is designed to be completely initiated and operated by users on each side of the transaction themselves (i.e. by Manna Network' sellers and buyers). The Manna Network.com website software is merely a aid for the parties to follow but they set their own terms and conditions. 
...
<li>Buyer makes deposit and reports same to seller and Manna Network (causes the automatic extension of the freeze and starts of second timer against the seller providing them time to verify the deposit)</li></ul>
<li>At the expiration of the second timer the ad credits are automatically transferred to the BUYER'S Manna Network account</li>
...
<li>Seller checks for the deposit, finds none has been made, and reports false deposit to Manna Network** OR</li>
<li>Seller's inactivity causes Software/Manna Network to automatically transfers credits to buyer at expiration of second time limit period</li>
</ol>
...
<li><a href='adcredit_exchange/termsofservice.php?action=seller'>View Terms Of Service </a></li>
<li><a href='adcredit_exchange_offer.php'>Offer Advertising Credits \"For Sale\"</a>
<ul>
<li><a href='adcredit_exchange/rud_seller.php'>View/Edit/Cancel/Transfer Current Offers</a></li>
</ul>
</li>
<!--<li><a href='adcredit_exchange/counteroffer.php?action=seller'>Respond To A Counter Offer Made By A Buyer</a></li>-->
<li><a href='adcredit_exchange/arbitration.php?action=seller'>Report A False Deposit Report On The Buyer/Force Arbitration</a></li>
</ul>
</td></tr>
<tr><td>&nbsp;
</td></tr>
...
$msg .="<H2>BUYERS</h2><ul>
<li><a href='adcredit_exchange/instructions.php?action=buyer'>View Instructions - Buyer</a></li>
<li><a href='adcredit_exchange/termsofservice.php?action=buyer'>View Terms Of Service - Buyer</a></li>
<li><a href='adcredit_exchange/listings_buyer.php'>View/Buy Advertising Credits \"For Sale\"</a>
<ul>
<li><a href='adcredit_exchange/rud_buyer.php'>View/Cancel/Report Payment/</a></li>
</ul>

</li>
<li><a href='adcredit_exchange/buyerreport.php'>Report Your Deposit To The Buyer</a></li>
<li><a href='adcredit_exchange/arbitration_buyer.php?action=buyer'>Rget_header();espond To A False Deposit Report/Arbitration</a></li>
</ul></td></tr>";
