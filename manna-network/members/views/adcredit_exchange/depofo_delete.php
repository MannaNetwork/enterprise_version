...
$adCreditExchange = new adCreditExchange;
$adCreditExchange->delete_depofo($depofonumber);

header( "refresh:5;url=slr_admin_profile.php" );
echo '<h1 style="color:red;">Your settings have been deleted. This page will refresh to your profile page to see the changes in five seconds.</h1>';
exit();
}
else
{
header( "refresh:5;url=slr_admin_profile.php" );
echo '<h1 style="color:red;">You didn\'t check the box to delete and neither did you select "NO". This page will refresh to your profile page to see the changes in five seconds.</h1>';
exit();
}
}
...
<tr><td>Account Number</td><td>Name On<br> Account</td><td>DELETE? </td></tr>';
...
$msg .= '<tr><td>'.$value.'</td><td>'.$decrypted2[$key].'</td><td><input type="checkbox" name="delete">';
...
$msg .= '
<tr><td colspan="2"><input type="submit" name="A1" value="DELETE BANK ACCOUNT PROFILE"></td><td colspan = "1"><input type="submit" name="cancel" value="NO"></td></tr></form></table>';
}//closes if count
