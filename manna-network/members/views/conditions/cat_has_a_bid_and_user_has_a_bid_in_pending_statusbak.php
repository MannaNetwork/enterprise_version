...
$steps_display .= '<div class="wrapper">   
 ...
 $steps_display .= '</form></td>';
      echo '<br>in cat_has_bid_and_user_in_pending.php - dirname( __FILE__, 2 ) = ', dirname( __FILE__, 2 ).'/includes/right_column.php';
...
//$this_links_rank will bring back the number of bids HIGHER than theirs. Add 1 to the value to give their rank
$this_links_rank = $this_links_rank + 1;
if($BSVpopulation > 0){
