...
//we need to convert this showSubLoc1 to include these vars (to match the function in mn_ajax.js) and make it operate like the one in register form (at least in this regions form). Vars to add are str, main_cat_nonce,currentLevel,cat_id,type {main_cat_nonce can be empty because is only used in WP)
