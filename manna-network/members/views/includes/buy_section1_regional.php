...
switch ($key) {
 ...
 $display_block .= '<div class="item'.$key.'">
 <h5>Placement At '.$level.' Level</h5>
 ...
 <input type="hidden" name="cat_id" value="'.$_GET['category_id'].'">
 <input type="hidden" name="installer_id" value="'.$_GET['installer_id'].'">
 <input type="hidden" name="location_id" value="'.$value.'">
 <input type="hidden" name="coin_type" value="DMC">
 <input type="hidden" name="agent_ID" value="'.AGENT_ID.'">
 <input type="hidden" name="users_balances_string" value="'.$users_balances_string.'">';
 $display_block .= '<input type="submit" class="submit" name="B1" value="'.$regions_array[1][$key].'" style="
     border:0;
     background-color:transparent;
     color: blue;
     text-decoration:underline;
...
//Now make the form for the saved location id (i.e. the lowest region selected)
if($num_of_levels == 4){
$level = "City";
$display_block .= '<div class="item'.$key.'">
 <h5>Placement At '.$level.' Level</h5>
 ...
 <input type="hidden" name="agent_ID" value="'.AGENT_ID.'">
 <input type="hidden" name="users_balances_string" value="'.$users_balances_string.'">';
 $display_block .= '<input type="submit" class="submit" name="B1" value="'.$selected_region_row['name'].'" style="
     border:0;
     background-color:transparent;
     color: blue;
     text-decoration:underline;
