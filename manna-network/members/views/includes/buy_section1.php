...
foreach($regions_array[0] as $key=>$value){
 ...
 <input type="hidden" name="agent_ID" value="'.AGENT_ID.'">
 <input type="hidden" name="users_balances_string" value="'.$users_balances_string.'">';
  $display_block .= '<br>key = '. $key;
 $display_block .= '      value = '. $value;
 $display_block .= '     $regions_array[1] = '. $regions_array[1][$key];
...
//Make the final form for the link id that the user currently has. 
