...
$option_name = $key + 1;
$steps_display .= '<tr><td colspan="3"><h3 style="font-weight:bold;">Bid Option # '.$option_name.'</h3></td></tr><tr style="border-bottom: 1px solid #000;"><td><h5>'.$pre_blockt_text_message.'</h5><br>
