...
<h1 style="text-align: center;">Bitcoin Address Form</h1>

<p class="smallerFont" >These configuration settings tell us where to send your Bitcoin commissions. It is crucial for these settings to be made correctly. Also, these settings are specific to this particular URL. If you operate web directories on more than one site then each can either have their own unique wallet address (suggested) or can use this same address.
</td></tr>
<tr><td width="100%">
