...
<p class="smallerFont" >Change your web directory\'s location settings <a href="widget_process_edit.php?link_selected='.$link_selected.'">Edit Web Directory Installation Location</a>
...
$msg .=   '<p class="smallerFont" ><h1 style="color: navy;">Installation Instructions</h1>
<h2 style="color: white;">Change Location Configuration</h2>
<p class="smallerFont" > <a style="color: white;" href="widget_process_edit.php?link_selected='. $link_selected.'" title="Install Location" >Change Install Location Form</a>
<p class="smallerFont" >At Bungeebones we need to know where your web directory is installed for it to work properly.  Change this setting if you haved installed the web directory in a location and you want to relocate it to a different location.

<p class="smallerFont" > Using the fictitious YourSite.com domain as an example (<b>replace YourSite.com with your own actual domain</b>), then, you can place the web directory at YourSite.com/foo.php, YourSite.com/foo/bar.php, YourSite.com/foo/foo/bar.php etc.
...
<p class="smallerFont" >More information <a target="_blank" href="make_template.php?link_selected='. $link_selected.'">here on how to build your own web site template</a>.
<p class="smallerFont" >*For a fee of only $15 we can create the entire page which includes everything from creating your page template from your website to insertng the BungeeBones code. We will email you the finished page and all you will need to do is insert the file into your site at the proper location. We can even do that for you (if you give us access to the server your site is on) for only an additional $5. To order yours use the <a href="http://Bungeebones.com/feedback.php">contact form</a> in the left menu on the BungeeBones.com home page. 
...
<p class="smallerFont" >Within that first block of the Barebones code pasted on your page, everything from between the opening php tag (&lt;?php) to the second of the closing php tags (?&gt;) is critical to proper operation. Everything between that closing php tag and the closing head tag are, however, reserved for your own page\'s critical code. 
<p class="smallerFont" >Here is a list of some things that might be critical to the proper operation or display of your page and that you need to make certain remain included in the head section code (but after the BungeeBones code):
...
<p class="smallerFont" >After you have included all of your own needed head code you can close the head section with your current pages closing head tag.
...
<p class="smallerFont" > <a style="color: white;" href="widget_config.php?link_selected='. $link_selected.'"  >Customise</a>


</P>
<h2 style="text-align:left;  color: white;">Trouble Shooting</h2>
<p class="smallerFont" >There are basically just three things that can go wrong with your installation
...
<p class="smallerFont" >This is the easiest problem to fix. Just check that the directory name and the page name AND EXTENSION are correct in stage one. You can go and edit them and make sure of spelling and especially that the page name uses the .php extension (ie. its name is something like "index.php").
<h3 style="text-align:left; ">2) Wrong Host Settings</h3>
<p class="smallerFont" >BungeeBones uses a software project called <a target="_blank" href="curl.haxx.se">CURL</a> which provides a library and command-line tool for transferring data between servers. If your hosting company does not have CURL installed then BungeeBones won\'t work there. 
<p class="smallerFont" >There are two ways to determine if your hosting company supports CURL. The first is quite easy. You simply ask them. CURL is widely used and they most likely are familar with it. If it is not installed ask them if they will install it for you.
<p class="smallerFont" >If for some reason you can\t find out from your hosting company then you can add just one more page to your directory that you will add just three lines of code in it like below
<p class="smallerFont" >&lt;?php
<p class="smallerFont" >echo phpinfo();
<p class="smallerFont" >?&gt;
...
$msg .= '<a name="custom"></a> <table style = "margin-left:auto; 
    margin-right:auto;" bgcolor="gray" width="75%" id="member" ><tr><td><p style="text-align:left; font-size: 125%;"> ';

$msg .=   '<p class="smallerFont" ><h1 style="color: navy;">Commission Withdrawals</h1>
<h2 style="color: white;">Step 1 - Required - You need a Bitcoin Wallet and Address</h2>
<p class="smallerFont" > <a style="color: white;" href="bitcoin_address_form.php?link_selected='. $link_selected.'" title="bitcoin Address Form" >Bitcoin Address Form</a>
<p class="smallerFont" >You need to add your Bitcoin address to our <a href="bitcoin_address_form.php?link_selected='. $link_selected.'" title="Bitcoin Address" >Bitcoin Address Form</a>.

<p class="smallerFont" > In order for us to be able to send you your commission payments you must have a Bitcoin wallet (all commissions are paid in Bitcoin ONLY). You can learn about Bitcoin and download a wallet <a target="_blank" href="http://bitcoin.org/en/choose-your-wallet">HERE</a>. You can use any wallet that fits your needs and situation (i.e. software, mobile, or web wallets) and we will send your commissions anywhere you tell us to send it to.




 <h2 style="color: white;">Step 2 - Authorize A Bitcoin Commission Withdrawal</h2> 
<p class="smallerFont" > <a style="color: white;" href="widget_comm_withdraw.php?link_selected='. $link_selected.'" title="Commission Withdrawal" >Commission Withdrawal Form</a>
</td></tr></table>';

}

/*
$msg .=   '<p class="smallerFont" ><h1 style="color: white;">Install Instructions</h1> <a style="color: white;" href="widget_install.php?link_selected='. $link_selected.'" title="Install Location" rel="gb_pageset[search_sites]">Install Location</a> | <a style="color: white;" href="widget_config.php?link_selected='. $link_selected.'"  rel="gb_pageset[search_sites]">Customize</a> | <a style="color: white;" href="widget_template_version_code.php?link_selected='. $link_selected.'"rel="gb_pageset[search_sites]">Template Version Code</a> | <a style="color: white;" href="widget_barebones_version_code.php?link_selected='. $link_selected.'"  rel="gb_pageset[search_sites]">BareBones Version Code</a>
</td></tr></table>';*/
