...
echo 'line 8 reg form/index_edit.php var  = ';
print_r ($var);
$url_cat = $var[1] ;
$link_id = $var[2] ;
$orig_cat_id_from_link = $url_cat;
...
</td></tr><tr><td bgcolor="cccccc"><h1>Format 1 - Copy & Paste All The Code In This Block Into A Blank Webpage</h1>		
&lt;?php
...
<form name="form1" method="GET" action="http://bungeebones.com/members/reg_form/index_edit.php"  onSubmit="return checkrequired(this)">
<input type="hidden" name="orig_cat_id_from_link" value="<?echo $orig_cat_id_from_link;?>">							 
...
If($cat_id>1){
//This is the table for determining numbers of competitors by region and by category. It needs to be in a section teaching how to bid, not here. This iframe also commented out in index page
//echo '<iframe id="buffer2" name="buffer2" src="http://bungeebones.com/members/add_link/index.php" width="500" border="0"height="375"></iframe>';
	///////////////////////////////
		///////    AJAX AJAX AJAX  /////////
		////////////////////////////////
...
$url_cat = $var[1] ;//repnaming header_ID
//$regional_number = $var[2] ;//repnaming header_ID
//$cat_id_orig = $var[2] ;//repnaming header_ID
$website_id = $var[2] ;//repnaming header_ID
...
echo '<table width = "500" ><tr><td><p>&nbsp;</p><p>&nbsp;</p><div style="color: black; background-color: #ebebeb"><p>&nbsp;</p><h1 style="color: red";>STEP 3 - Edit Your Link Info If You Wish</h1>
