...
echo '<h3>line 44 widget install </h3>', $sql;
...
echo '<h3>line 58 widget install </h3>', $sql;
$result = @mysqli_query($connect, $sql);
while($row = mysqli_fetch_array($result)){
$future_widget_parents_link_num = $row['wdgts_lnk_num'];
}
echo  ' <h1>line 63 $future_widget_parents_link_num = </h1>', $future_widget_parents_link_num;
...
echo '<h3>line 72 future_widget_parents_link_num should be 3 when bungeebones is parent</h3>', $future_widget_parents_link_num;
include($_SERVER['DOCUMENT_ROOT']."/db_cfg/db2bbconfig.php");
include($_SERVER['DOCUMENT_ROOT']."/db_cfg/connectloginmysqli.php");
...
echo '<h3>line 75 widget install </h3>', $sql;
$result = @mysqli_query($connect, $sql);
while($row = mysqli_fetch_array($result)){
$url	= $row['url'];
}
...
echo '<h3>line 82 widget install </h3>', $sql;
$result = @mysql_query($connect, $sql);
while($row = mysql_fetch_array($result)){
$parent_num	= $row['id'];
}	
echo '<h3>line 90 before IF </h3>', $parent_num,$baby_widget,$parent_num,$folder_name, $file_name;
...
echo '<h3>line 92 widget install </h3>', $sql;
...
$result = @mysqli_query($connect, $sql);
include($_SERVER['DOCUMENT_ROOT']."/classes/widget_mgr/widget_mgmt_class.php");
...
echo "$thanks";
//include($_SERVER['DOCUMENT_ROOT']."/includesorig/templatebottomsb.php");
