...
<p align="left">When a visitor wishes to add a link to your/our web directory they need to do so at our server so that we can distribute their information to the other installations and also in order to pay you for whatever purchases they make. If they were to suddenly find themselves on our site rather than yours they might get upset so we provide this transition page or "leaving" page where we prepare them for the move. The page opens when they click the "Add A :ink" button on your website and used to open in a new window. But now it opens in a much more professional looking "modal" window. 

<p align="left">The page used to be located on our server but is now included in the installation files. It is easier to edit the page and customize it in any fashion and manner you like and we encourage our users to do so. It provides you, our users, the opportunity to give BungeeBones your own personal recommendation and endorsement. If users from your site don't go beyond just adding a free link then neither of us earn anything. On the other hand, if you provide some marketing help it may prove to be just the encouragement the new user needed to enter in the buying mood.
<p align="left"><b>If this is a new install then the file is located in your installation folder/modal/leaving_website.php. You can open it with an editor and change/modify/replace as you wish.</b>
...
<p align="left">The default "Add A Link" images are located in the /modal directory. The easiest way is to make backups of the existing images and then save new images with the exact same names in their place. Image addalinkbb1.gif loads on page load, addalinkbb2.gif is the mouseover image and addalinkbb3.gif is what it returns to on mouseout.
</p>
...
<option value="140" >Larger+</option>
<option value="180" >Larger++</option>
<option value="220" >Largest</option>
...
<p><h3>Check box to make your link "no follow"</h3><input type="checkbox" name="no_follow_act" value="on" ></p>
<p>&nbsp;</p>
