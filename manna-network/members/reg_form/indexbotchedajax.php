...
$body_width="wide";
include('../../960top_regform.php');
echo '
<div style="text-align: center;">
   				<a href="/members" class="cssbutton sample a"><span>User CP Home</span></a>&nbsp;
...
<a href="/feedback.php" class="cssbutton sample a"><span> Support </span></a>&nbsp;<a href="/articles/terms_of_service.php" class="cssbutton sample a"><span> Terms Of Service </span></a>&nbsp;<a href="/members/index.php?action=log_out" class="cssbutton sample a"><span> LOG Out </span></a>&nbsp;
					</div>';
...
<table id="member">
<tr>
<td><p class="smallerFont" >Move yourself up in the rankings by reporting bad links in your own category! Help us eliminate dead, broken, or mis-categorized links in the sites that are listed ahead of yours and move your link higher at the same time!</p>
...
echo'<h2>Coming SOON!</h2><h3>SEO Locality Enhancement Tool</h3>
<p style="text-align: left;">You will soon be able to add additional Regional Info which will be posted along with your link information and help your rankings for Search Engine queries in that area.</p>';
?>
...
<input type="hidden" name = "affiliate_num" value="<?echo $affiliate_num;?>">
<input type="hidden" name = "cat_page_num" value="<?echo $cat_page_num;?>">
<input type="hidden" name = "locus_array" value="<?echo $locus_array;?>">
