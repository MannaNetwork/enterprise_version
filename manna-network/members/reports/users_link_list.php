...
$link_submitters_id = $check_security ->_INPUT('link_submitters_id');
...
$this_userslist_of_links = $get_reports ->getSubmittersLinks($link_submitters_id);
...
foreach( $orig_id as $key => $value){


$tab_bod .= '<tr><td class="leftcontent">'.$orig_id[$key].'</td><td>'.$orig_name[$key].'</td><td>'.$orig_description[$key]   .'</td><td class = "centerleftcontent">'.$orig_BB_user_ID[$key].'</td><td class="centerrightcontent"> '.$orig_category[$key].'</td><td class="rightcontent">'.date("Y/m/d", $orig_start_date[$key]).'</td><td><a href="users_link_list.php?user_id='.$key.'">View User\'s Links</a></tr>';

}

$tab_hd .= '<tr class="toprow"><td class="leftcol">Link ID </td><td> Real Name</td><td class = "centerleftcontent">  # Of Links<br>Entered</td><td class = "centerleftcontent">   Upline Number</td><td class="centerrightcontent">  Category</td><td class="rightcontent"> Start Date</td><td>View Link Info(s)</td></tr>';
