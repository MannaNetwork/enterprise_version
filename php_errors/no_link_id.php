...
echo ' 
<h3 style="color:red;">Configuration Instructions!</h3>
<h3 style="color:red;">This web directory page will enable you to earn Bitcoin SV. To get credited AND displayed properly you need to configure the member_config.php file.</h3>';
